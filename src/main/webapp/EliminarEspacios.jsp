...
<title>Eliminador de Espacios</title>
<link
		...
		<div class="row">
			<div class="col-12 col-md-8 col-lg-6 mx-auto">
				<main class="bg-light py-3 px-4 border rounded">
					...
					<h1>Eliminador de Espacios</h1>
					<h2 class="author fs-5 border-bottom d-inline">Alejandro Díaz</h2>
					<p id="descripcion">Eliminación de espacios en ambos lados sin afectar a los del medio.</p>
					<form method="POST" action="EliminarEspacios">
