            ...
            <div class="row">
                <div class="col-12 col-md-8 col-lg-6 mx-auto">
                    <main class="bg-light py-3 px-4 border rounded">
                        ...
                        <h1>MAYÚSCULAS</h1>
                        <h2 class="author fs-5 border-bottom d-inline">Francisco José Vázquez</h2>
                        <p id="descripcion">Pasar un texto a Mayusculas</p>

						<p>
							<%if(request.getAttribute("mayuscula") != null){ %>
							 	Resultado: 
								<b>
									
										<%=request.getAttribute("mayuscula")%>
